# UI: Unemployment Insurance Benefits Calculator for Part-time Workers

Welcome to the Commonwealth of Massachusetts' Single Page Application (SPA), powering the "Unemployment Insurance Benefits Calculator for Part-time Workers" . This is a static website built with React, [Mayflower React](https://github.com/massgov/mayflower/) (Commonwealth's Design System), and our [Mayflower React Starter](https://github.com/massgov/mayflower-react-starter/). The [Mayflower React Starter](https://github.com/massgov/mayflower-react-starter/) is a customized instance of [Facebook's Create React App](https://github.com/facebook/create-react-app).
